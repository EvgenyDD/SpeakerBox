/**
  ******************************************************************************
  * @file    STM32L152_Ex07_10TKeys_Lin_Rot_TS_EVAL\inc\tsl_conf_stm32l1xx.h
...
*/
#define TSLPRM_TOTAL_TOUCHKEYS_B (5)
...
*/
#define TSLPRM_TKEY_CALIB_TH (28)
...
*/
#define TSLPRM_LINROT_DIR_CHG_POS (15)
...
/** Direction change debounce (range=0..63)
  ...
  - A High value will result in a slower direction change.
*/
#define TSLPRM_LINROT_DIR_CHG_DEB (2)
...
*/
#define TSLPRM_DELAY_TRANSFER (0)

/**Use Spread Spectrum (0=No, 1=Yes)
@note for SW acquisition only
*/
#define TSLPRM_USE_SPREAD_SPECTRUM (0)
