/**
 ******************************************************************************
 * @file    STM32L152_Ex07_10TKeys_Lin_Rot_TS_EVAL\src\tsl_user.c
...
{
	{
		...
		MyChannels_Data,
		BANK_0_NBCHANNELS,
		BANK_0_SHIELD_SAMPLE,
		BANK_0_SHIELD_CHANNEL
	},
	{
		&MyChannels_Src[4],
		&MyChannels_Dest[4],
		MyChannels_Data,
		BANK_1_NBCHANNELS,
		BANK_1_SHIELD_SAMPLE,
		BANK_1_SHIELD_CHANNEL
	},
	{
		&MyChannels_Src[8],
		&MyChannels_Dest[8],
		MyChannels_Data,
		BANK_2_NBCHANNELS,
		BANK_2_SHIELD_SAMPLE,
		BANK_2_SHIELD_CHANNEL
	}/*,
	{ // touchkeys
		&MyChannels_Src[3],
		&MyChannels_Dest[3],
		MyChannels_Data,
		BANK_3_NBCHANNELS,
		BANK_3_SHIELD_SAMPLE,
		BANK_3_SHIELD_CHANNEL
	},
	{ // touchkeys
		&MyChannels_Src[4],
		&MyChannels_Dest[4],
		MyChannels_Data,
		BANK_4_NBCHANNELS,
		BANK_4_SHIELD_SAMPLE,
		BANK_4_SHIELD_CHANNEL
	},
	...
	{ // linear sensor
		...
		MyChannels_Data,
		BANK_5_NBCHANNELS,
		BANK_5_SHIELD_SAMPLE,
		BANK_5_SHIELD_CHANNEL
	}*/
	/*,
	{
		&MyChannels_Src[12],
...
// Calibration states
	/*  0 */
	{ TSL_STATEMASK_CALIB, TSL_tkey_CalibrationStateProcess },
	/*  1 */
	{ TSL_STATEMASK_DEB_CALIB, TSL_tkey_DebCalibrationStateProcess },
	// Release states
	/*  2 */
	{ TSL_STATEMASK_RELEASE, TSL_tkey_ReleaseStateProcess },
#if TSLPRM_USE_PROX > 0
	/*  3 */
	{	TSL_STATEMASK_DEB_RELEASE_PROX, TSL_tkey_DebReleaseProxStateProcess},
#else
	/*  3 */
	{ TSL_STATEMASK_DEB_RELEASE_PROX, 0 },
#endif
	/*  4 */
	{ TSL_STATEMASK_DEB_RELEASE_DETECT, TSL_tkey_DebReleaseDetectStateProcess },
	/*  5 */
	{ TSL_STATEMASK_DEB_RELEASE_TOUCH, TSL_tkey_DebReleaseTouchStateProcess },
#if TSLPRM_USE_PROX > 0
	// Proximity states
	/*  6 */
	{	TSL_STATEMASK_PROX, TSL_tkey_ProxStateProcess},
	/*  7 */
	{	TSL_STATEMASK_DEB_PROX, TSL_tkey_DebProxStateProcess},
	/*  8 */
	{	TSL_STATEMASK_DEB_PROX_DETECT, TSL_tkey_DebProxDetectStateProcess},
	/*  9 */
	{	TSL_STATEMASK_DEB_PROX_TOUCH, TSL_tkey_DebProxTouchStateProcess},
#else
	/*  6 */
	{ TSL_STATEMASK_PROX, 0 },
	/*  7 */
	{ TSL_STATEMASK_DEB_PROX, 0 },
	/*  8 */
	{ TSL_STATEMASK_DEB_PROX_DETECT, 0 },
	/*  9 */
	{ TSL_STATEMASK_DEB_PROX_TOUCH, 0 },
#endif
	// Detect states
	/* 10 */
	{ TSL_STATEMASK_DETECT, TSL_tkey_DetectStateProcess },
	/* 11 */
	{ TSL_STATEMASK_DEB_DETECT, TSL_tkey_DebDetectStateProcess },
	// Touch state
	/* 12 */
	{ TSL_STATEMASK_TOUCH, TSL_tkey_TouchStateProcess },
	// Error states
	/* 13 */
	{ TSL_STATEMASK_ERROR, MyTKeys_ErrorStateProcess },
	/* 14 */
	{ TSL_STATEMASK_DEB_ERROR_CALIB, TSL_tkey_DebErrorStateProcess },
	/* 15 */
	{ TSL_STATEMASK_DEB_ERROR_RELEASE, TSL_tkey_DebErrorStateProcess },
	/* 16 */
	{ TSL_STATEMASK_DEB_ERROR_PROX, TSL_tkey_DebErrorStateProcess },
	/* 17 */
	{ TSL_STATEMASK_DEB_ERROR_DETECT, TSL_tkey_DebErrorStateProcess },
	/* 18 */
	{ TSL_STATEMASK_DEB_ERROR_TOUCH, TSL_tkey_DebErrorStateProcess },
	// Other states
	/* 19 */
	{ TSL_STATEMASK_OFF, MyTKeys_OffStateProcess } };

const TSL_TouchKeyMethods_T MyTKeys_Methods = { TSL_tkey_Init, TSL_tkey_Process };
...
const TSL_TouchKeyB_T MyTKeysB[5] =
{
	...
	{ &MyTKey4Data, &MyTKey4Params, &MyChannels_Data[CHANNEL_4_DEST] },
};
...
const TSL_State_T MyLinRots_StateMachine[] =
	{
		// Calibration states
		/*  0 */
		{ TSL_STATEMASK_CALIB, TSL_linrot_CalibrationStateProcess },
		/*  1 */
		{ TSL_STATEMASK_DEB_CALIB, TSL_linrot_DebCalibrationStateProcess },
		// Release states
		/*  2 */
		{ TSL_STATEMASK_RELEASE, TSL_linrot_ReleaseStateProcess },
#if TSLPRM_USE_PROX > 0
		/*  3 */
		{	TSL_STATEMASK_DEB_RELEASE_PROX, TSL_linrot_DebReleaseProxStateProcess},
#else
		/*  3 */
		{ TSL_STATEMASK_DEB_RELEASE_PROX, 0 },
#endif
		/*  4 */
		{
			TSL_STATEMASK_DEB_RELEASE_DETECT,
			TSL_linrot_DebReleaseDetectStateProcess },
		/*  5 */
		{
			TSL_STATEMASK_DEB_RELEASE_TOUCH,
			TSL_linrot_DebReleaseTouchStateProcess },
#if TSLPRM_USE_PROX > 0
		// Proximity states
		/*  6 */
		{	TSL_STATEMASK_PROX, TSL_linrot_ProxStateProcess},
		/*  7 */
		{	TSL_STATEMASK_DEB_PROX, TSL_linrot_DebProxStateProcess},
		/*  8 */
		{	TSL_STATEMASK_DEB_PROX_DETECT, TSL_linrot_DebProxDetectStateProcess},
		/*  9 */
		{	TSL_STATEMASK_DEB_PROX_TOUCH, TSL_linrot_DebProxTouchStateProcess},
#else
		/*  6 */
		{ TSL_STATEMASK_PROX, 0 },
		/*  7 */
		...
		// Detect states
		/* 10 */
		{ TSL_STATEMASK_DETECT, TSL_linrot_DetectStateProcess },
		/* 11 */
		{ TSL_STATEMASK_DEB_DETECT, TSL_linrot_DebDetectStateProcess },
		// Touch state
		/* 12 */
		{ TSL_STATEMASK_TOUCH, TSL_linrot_TouchStateProcess },
		// Error states
		/* 13 */
		{ TSL_STATEMASK_ERROR, MyLinRots_ErrorStateProcess },
		/* 14 */
		{ TSL_STATEMASK_DEB_ERROR_CALIB, TSL_linrot_DebErrorStateProcess },
		/* 15 */
		{ TSL_STATEMASK_DEB_ERROR_RELEASE, TSL_linrot_DebErrorStateProcess },
		/* 16 */
		{ TSL_STATEMASK_DEB_ERROR_PROX, TSL_linrot_DebErrorStateProcess },
		/* 17 */
		{ TSL_STATEMASK_DEB_ERROR_DETECT, TSL_linrot_DebErrorStateProcess },
		/* 18 */
		{ TSL_STATEMASK_DEB_ERROR_TOUCH, TSL_linrot_DebErrorStateProcess },
		// Other states
		/* 19 */
		{ TSL_STATEMASK_OFF, MyLinRots_OffStateProcess } };
...
const uint16_t MyLinRot0_DeltaCoeff[6] = {0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100};
...
{
	{
		...
		(TSL_tsignPosition_T *) TSL_POSOFF_6CH_LIN_M1,
		TSL_SCTCOMP_6CH_LIN_M1,
		TSL_POSCORR_6CH_LIN_M1,
...
petersons_t stm_studio_lock =
{
{ 0, 0 }, TARGET_LOCK_ID
}; // Do not modify - shared with STMStudio host software
...
/**Set thresholds for each object (optional).*/
void TSL_user_SetThresholds()
{
	/*
	// K2 thresholds modification
	MyTKeysB[0].p_Param->DetectInTh = 15;
	MyTKeysB[0].p_Param->DetectOutTh = 10;
	MyTKeysB[0].p_Param->CalibTh = 15;

	// K3 thresholds modification
	MyTKeysB[1].p_Param->DetectInTh = 15;
	MyTKeysB[1].p_Param->DetectOutTh = 10;
	MyTKeysB[1].p_Param->CalibTh = 15;
	...
	// K6 thresholds modification
	MyTKeysB[5].p_Param->DetectInTh = 15;
	MyTKeysB[5].p_Param->DetectOutTh = 10;
	MyTKeysB[5].p_Param->CalibTh = 15;

	// K9 thresholds modification
	MyTKeysB[2].p_Param->DetectInTh = 15;
	MyTKeysB[2].p_Param->DetectOutTh = 10;
	MyTKeysB[2].p_Param->CalibTh = 15;

	// K10 thresholds modification
	MyTKeysB[3].p_Param->DetectInTh = 15;
	MyTKeysB[3].p_Param->DetectOutTh = 10;
	MyTKeysB[3].p_Param->CalibTh = 15;*/
}

/**To call before modifying any critical data. In case the host is
...
void enterLock()
{
	...
	while (stm_studio_lock.flag[HOST_LOCK_ID]
		&& (stm_studio_lock.turn == HOST_LOCK_ID))
	{
	}
}

/**Leave the critical section. If the host is waiting, access will be
